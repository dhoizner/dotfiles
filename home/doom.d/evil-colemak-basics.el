...
(defcustom evil-colemak-basics-mod-dhm t
  "Whether to map for Colemak mod-DHm

By default, vanilla Colemak mappings are assumed; when non-nil,
this will set mappings for Colemak mod-DHm"
  :group 'evil-colemak-basics
  :type 'boolean)
...
(defun evil-colemak-basics--make-keymap ()
  ...
  (let ((keymap (make-sparse-keymap)))
    ...
    (when evil-colemak-basics-mod-dhm
      (evil-define-key '(motion normal visual) keymap
        "m" 'evil-backward-char))
    keymap))
