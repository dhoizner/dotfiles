...
keymap("n", "<leader>fm", function() MiniFiles.open(vim.api.nvim_buf_get_name(0)) end, { desc = "[M]ini [F]iles" })
...
keymap("n", "<leader>wh", "<C-w>h",           { noremap = true, silent = true, desc = "Focus [L]eft" })
keymap("n", "<leader>wj", "<C-w>j",           { noremap = true, silent = true, desc = "Focus [D]own" })
keymap("n", "<leader>wk", "<C-w>k",           { noremap = true, silent = true, desc = "Focus [U]p" })
keymap("n", "<leader>wl", "<C-w>l",           { noremap = true, silent = true, desc = "Focus [R]ight" })
